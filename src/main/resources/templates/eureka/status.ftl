...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body id="one">
    ...
    <div class="container-fluid xd-container">
      <#include "navbar.ftl">
      <h1>当前注册到服务中心的实例</h1>
      <table id='instances' class="table table-striped table-hover table-bordered">
        <thead>
          <tr><th>应用服务</th><th>AMIs</th><th>可用区域</th><th>状态</th></tr>
        </thead>
        <tbody>
          <#if apps?has_content>
            <#list apps as app>
      ...
      <table id='generalInfo' class="table table-striped table-hover table-bordered">
        <thead>
      ...
      <table id='instanceInfo' class="table table-striped table-hover table-bordered">
        <thead>
          <tr><th>名称</th><th>值</th></tr>
        <thead>
        <tbody>
